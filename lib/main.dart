...
ThemeData appTheme = ThemeData(
    ...
    /* Colors.tealAccent,*/
    secondaryHeaderColor: Colors.black /* Colors.teal*/
    // fontFamily:
    );
                    ...
                    FittedBox(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            const url =
                                'mailto:rajuna807@gmail.com?subject=I am using your flutter project so';
                    ...
                    FittedBox(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            const url = 'https://www.instagram.com/babeluvv0_/';
                            if (await canLaunch(url)) {
                              await launch(url);
                            } else {
                              throw 'Could not launch $url';
                    ...
                    FittedBox(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            const url = 'https://t.me/sheisheiaja';
                            if (await canLaunch(url)) {
                              await launch(url);
                            } else {
                              throw 'Could not launch $url';
                    ...
                    FittedBox(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            const url = 'https://wa.me/+6289697249467';
                            if (await canLaunch(url)) {
                              await launch(url);
                            } else {
                              throw 'Could not launch $url';
...
var selectedloc = 0;
List<String> locs = ['Indonesia (+62)', 'Malang (N)'];
    ...
    Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Spacer(),
          Text("lihat semua", style: viewallstyle)
        ],
      ),
    ),
    Container(
